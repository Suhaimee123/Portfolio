    ...
    <section className="relative w-full min-h-[80vh] flex flex-col items-center justify-center overflow-hidden pt-20">
      ...
      <div className="z-10 text-center px-4 max-w-5xl mx-auto flex flex-col items-center">
        ...
        <p className="text-base md:text-xl text-zinc-300 max-w-3xl mb-10 leading-relaxed">
          นักพัฒนาซอฟต์แวร์ที่มีประสบการณ์รวม 1 ปี 11 เดือน ในการทำ Web Application ทั้งฝั่ง Frontend และ Backend มีความถนัดในการเขียนระบบที่มี Logic ซับซ้อน เช่น ระบบ POS ร้านอาหารที่พัฒนาขึ้นมาเอง ควบคู่ไปกับประสบการณ์ทำงานจริงในระบบของบริษัท เน้นการเขียนโค้ดที่เป็นระเบียบ และชอบเรียนรู้เทคโนโลยีใหม่ๆ อยู่เสมอครับ
        </p>
