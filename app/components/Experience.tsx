...
const experiences = [
  {
    ...
    type: 'งานประจำ',
    highlights: [
      'Gold Trading & IoT Integration: ร่วมพัฒนาเว็บแอปพลิเคชันระบบซื้อขายทองคำ และพัฒนาระบบเชื่อมต่อเครื่องชั่งดิจิทัลระดับอุตสาหกรรมด้วย Web Serial API เพื่ออ่านและบันทึกค่าน้ำหนักจริงแบบ Real-time',
      'Backend & Database Synchronization: ร่วมพัฒนาฐานข้อมูลและตรรกะฝั่งหลังบ้าน (NestJS + Prisma) เพื่อคำนวณและซิงค์ยอดชำระเงินคืนค่ากำเหน็จ (Wage Refund) และรายการส่งคืนทองชำรุด (Damaged Stock)',
      'Security & Authorization: เพิ่มระบบยืนยันสิทธิ์ระดับผู้จัดการ (Manager Authentication) ในการอนุมัติชำระบัญชีข้ามธุรกรรม และระบบป้องกันยกเลิกรายการชำระบัญชีในสถานะ Converted',
      'Data Cleansing & Migration: พัฒนาชุดสคริปต์ Python & Pandas เพื่อทำความสะอาดและนำเข้าฐานข้อมูลสินค้า (SKUs) และคู่ค้าช่างทองจำนวนมากจากระบบเดิมเข้าสู่ระบบใหม่ได้อย่างปลอดภัย',
      'Real-time Navigation & Dashboard: พัฒนาระบบติดตามพิกัดตำแหน่งพนักงานขายแบบเรียลไทม์ และหน้าแดชบอร์ดสรุปวิเคราะห์ยอดขายเพื่อสนับสนุนการตัดสินใจเชิงธุรกิจ'
    ]
  },
  {
