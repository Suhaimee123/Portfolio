  ...
  return (
    <section id="experience" className="py-24 relative border-t border-white/5">
      <div className="mb-16 flex flex-col items-center lg:items-start">
        <h2 className="text-4xl font-extrabold mb-6 tracking-tight">ประสบการณ์การทำงาน</h2>
        <div className="w-20 h-1.5 bg-gradient-to-r from-blue-500 to-emerald-500 rounded-full" />
      </div>

      <div className="grid grid-cols-1 gap-8">
        {experiences.map((exp, idx) => (
          <div key={idx} className="group relative p-8 rounded-3xl bg-zinc-900/20 border border-white/5 hover:border-white/10 transition-all hover:bg-zinc-900/40">
